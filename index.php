...
<body>
            ...
            <div class="row">
                <div class="col-md-6 text-center text-lg-start mb-2 mb-lg-0">
                    <div class="d-inline-flex align-items-center">
                        <a class="text-dark py-2 pe-3 border-end border-white" href=""><i class="bi bi-telephone text-secondary me-2"></i>+91 9876543210</a>
                        <a class="text-dark py-2 px-3" href=""><i class="bi bi-envelope text-secondary me-2"></i>faizan123.com</a>
                    </div>
                </div>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <div class="d-none d-lg-flex align-items-center ps-4">
                ...
                <div><div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown"><i style="font-size:20px"class="bi bi-person-lines-fill"></i></a>
                    <div class="dropdown-menu m-0">
                        <a href="login.php" class="dropdown-item active">Login</a>
                        <a href="signup.php" class="dropdown-item">Sign Up</a>
                    </div>
                    <!-- <h5 class="text-primary mb-1" ><a href="login.php">Login</a></h5> -->
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="https://www.wembleypaints.com/assets/img/slider-2.jpg" alt="First slide">
    </div>
  </div>
</div>
    <!-- Hero End -->
            ...
            <div class="row gx-0 mb-3 mb-lg-0">
                <div class="col-lg-6 my-lg-5 py-lg-5">
                    <div class="about-start bg-primary p-5">
                        ...
                        <a href="contact.php" class="btn btn-secondary rounded-pill py-md-3 px-md-5 mt-4">Contact Us</a>
                    </div>
                </div>
                    ...
                    <div class="team-item">
                        ...
                        <div class="team-text">
                            ...
                            <div class="mt-auto mb-3">
                                <h4 class="mb-1">Victor</h4>
                                <span class="text-uppercase">Painter</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="team-item">
                        ...
                        <div class="team-text">
                            ...
                            <div class="mt-auto mb-3">
                                <h4 class="mb-1">Genoveva</h4>
                                <span class="text-uppercase">Site Manager</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="team-item">
                        ...
                        <div class="team-text">
                            ...
                            <div class="mt-auto mb-3">
                                <h4 class="mb-1">Paul</h4>
                                <span class="text-uppercase">Distributor</span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row g-0">
                <div class="col-md-6 text-center text-md-start">
                    <p class="mb-md-0">Copyright &copy; <a class="text-dark fw-bold" href="#">Paint Shop</a>. All Rights Reserved.</p>
                </div>
                <div class="col-md-6 text-center text-md-end">
                    <p class="mb-0">Designed by <a class="text-dark fw-bold" href="https://htmlcodex.com">Faizan Ali</a></p>
