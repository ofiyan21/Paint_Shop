...
$sql = "INSERT INTO contact (name, email, subject, message)
	...
	$mail->send();
	 ...
	 echo '<script language="javascript">';
        echo 'alert("Message Received"); location.href="contact1.php"';
        echo '</script>';
        ...
        <div class="container py-5">
            <div class="row justify-content-start">
                <div class="col-lg-8 text-center text-lg-start">
                    ...
                    <div class="pt-2">
                        <a href="index1.php" class="btn btn-secondary rounded-pill py-2 px-4 mx-2">Home</a>
                        <a href="contact1.php" class="btn btn-secondary rounded-pill py-2 px-4 mx-2">Contact Us</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row g-3 mb-5">
                ...
                <div class="col-lg-4 col-md-6 pt-5">
                    <div class="contact-item d-flex flex-column align-items-center justify-content-center text-center pb-5">
                        ...
                        <h4 class="mt-5">faizanali@gmail.com</h4>
                    </div>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="bg-primary p-5 m-5 mb-0">
                        <form method="POST">
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    <input type="text" class="form-control bg-light border-0" placeholder="Subject" name="subject" style="height: 55px;" required>
                                </div>
                                <div class="col-12">
                                    <input class="form-control bg-light border-0" rows="5" name="message" placeholder="Message" required>
                                </div>
                                <div class="col-12">
